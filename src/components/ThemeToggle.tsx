...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border border-line bg-surface text-navy-700 shadow-soft transition-[background-color,transform] duration-200 hover:bg-sky-bg active:scale-90"
    >
      {dark ? (
        <svg
          key="sun"
